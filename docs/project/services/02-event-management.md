...
- **Casos de Uso:** [UC-EM-01, UC-EM-03, UC-EM-04, UC-EM-05](../../phases/phase-2/use-case-catalog.md).
- **Agregados:** [Event, Venue](../../phases/phase-1/aggregate-definitions.md).
- **Contrato API:** [Event Management Endpoints](../../phases/phase-3/service-contracts.md).
- **Diagrama ER:** [Modelo de Datos de Event Management](../../phases/phase-3/er-diagrams/event-management.md).
- **Decisión de Arquitectura:** [Catálogo colapsado como Read Model (ADR-010)](../../phases/phase-3/adrs/ADR-010-catalog-collapsed.md).
