...
- **Casos de Uso:** [UC-TI-01 al UC-TI-04](../docs/phases/phase-2/use-case-catalog.md).
- **Agregado:** [Ticket](../docs/phases/phase-1/aggregate-definitions.md).
- **Contrato API:** [Ticket Issuance Endpoints](../docs/phases/phase-3/service-contracts.md).
- **Diagrama ER:** [Modelo de Datos de Ticket Issuance](../docs/phases/phase-3/er-diagrams/ticket-issuance.md).
- **Decisión de Arquitectura:** [QR Dinámico con TTL (ADR-006)](../docs/phases/phase-3/adrs/ADR-006-dynamic-qr-ttl.md).
...
- [BR-TI-01 al BR-TI-08: Reglas de Emisión](../docs/phases/phase-2/business-rules.md).
