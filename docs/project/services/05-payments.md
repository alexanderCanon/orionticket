...
- **Casos de Uso:** [UC-PA-01, UC-PA-02, UC-PA-03](../../phases/phase-2/use-case-catalog.md).
- **Agregados:** [Payment, Payout](../../phases/phase-1/aggregate-definitions.md).
- **Contrato API:** [Payments Endpoints](../../phases/phase-3/service-contracts.md).
- **Diagrama ER:** [Modelo de Datos de Payments](../../phases/phase-3/er-diagrams/payments.md).
- **Decisión de Arquitectura:** [Liquidación post-fecha (ADR-009)](../../phases/phase-3/adrs/ADR-009-payout-after-date.md).
...
- [BR-PA-01 al BR-PA-08: Reglas de Pago](../../phases/phase-2/business-rules.md).
